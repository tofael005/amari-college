           ...
           <main className="max-w-[1240px] mx-auto mt-14">
            <div className='md:flex md:p-8 p-3  gap-6 justify-between'>
                ...
                <div className='py-5 bg-slate-100 rounded md:w-full mx-auto my-5'>
                    ...
                    <button className='border-2 border-[#05b6d1] p-2 mt-4 rounded flex justify-center items-center gap-[6px] mx-auto'><FcGoogle className='text-[32px]' /><span>Continue with Google</span></button>
                </div>
